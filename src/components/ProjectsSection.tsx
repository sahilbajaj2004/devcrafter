...
import adarsportfolio from "../assets/adarshport.png";
import sahilportfolio from "../assets/sahil.png";
import burrow from "../assets/burrow.png";
import picommunity from "../assets/pi.png";
    ...
    <section id="projects" className="relative py-24 bg-transparent overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Building sleek, high-impact digital experiences through a seamless blend of creativity, precision, and innovation.
        </motion.p>
                    ...
                    <img
                      src={
                        typeof project.image === "string"
                          ? project.image
                          : (project.image as any)?.src || "/placeholder.svg"
                      }
                      alt={project.title}
