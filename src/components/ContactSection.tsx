...
>>>>>>> 643596fea5bdc5c2eb93355441f7fe73a4ce4be1
            ...
            <div className="flex space-x-4 mt-8 relative">
              ...
              {/* SoberDev socials */}
              <motion.a
                href="https://twitter.com/soberdev"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <motion.a
                href="https://linkedin.com/in/soberdev"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-white/5 rounded-full text-white/60 hover:text-white hover:bg-white/10 transition-colors"
                whileHover={{ scale: 1.2, y: -2 }}
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <option
                  value="web"
                  className="bg-black text-white/90 font-thin"
                >
                  Web Application
                </option>
                <option
              ...
              {status && (
                <p className="text-white/70 mt-2 font-thin">{status}</p>
              )}
            </form>
          </div>
        </div>
